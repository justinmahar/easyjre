...
export default function CustomizeJREContainer(props: ICustomizeJREContainerProps) {
  return (
    <Container maxWidth={props.maxWidth} style={{ marginTop: '1rem', marginBottom: '1rem' }}>
      ...
      {props.intention !== CHOOSE_JDK_MODULES && (
        <>
          <ModulePathPaper modulePath={props.modulePath} setModulePath={props.setModulePath} />
      ...
      {props.intention !== CHOOSE_JDK_MODULES && props.intention !== MANUAL_MODULES && (
        <>
          <JdkBinPathPaper jdkBinPath={props.jdkBinPath} setJdkBinPath={props.setJdkBinPath} />
          <MiscOptionsPaper
