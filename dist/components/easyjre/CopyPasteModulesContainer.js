...
function CopyPasteModulesContainer(props) {
  ...
  return React.createElement(
    ...
    { maxWidth: props.maxWidth, style: { marginTop: '1rem', marginBottom: '1rem' } },
    React.createElement(
      material_1.Paper,
      { style: { padding: '2rem' } },
      ...
      React.createElement(
        'p',
        null,
        'Copy a list of the available Java modules by running the following command in the JDK bin folder:',
      ),
      React.createElement(
        'div',
        null,
      ...
      React.createElement(
        ...
        !props.jdkVersion &&
          React.createElement(
            ...
            navigatorClipboardSupported &&
              React.createElement(
                material_1.Button,
                { variant: 'contained', color: 'primary', onClick: () => handleClickPaste() },
                'Paste',
              ),
            !navigatorClipboardSupported &&
              React.createElement(
            ...
            React.createElement(material_1.Chip, {
              icon: React.createElement(material_1.Icon, null, 'not_interested'),
        ...
        props.jdkVersion &&
          React.createElement(
            ...
            null,
            React.createElement(material_1.Chip, {
              icon: React.createElement(material_1.Icon, null, 'check'),
            ...
            React.createElement(material_1.Chip, {
              icon: React.createElement(material_1.Icon, null, 'playlist_add_check'),
