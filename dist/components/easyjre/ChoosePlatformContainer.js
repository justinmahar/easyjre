...
function ChoosePlatformContainer(props) {
    const handleListItemClick = (_event, index) => {
        props.setPlatform(platforms_1.default[index]);
    };
    const listItems = platforms_1.default.map((platform, index) => {
        return (React.createElement(material_1.ListItem, { key: index, role: undefined, dense: true, button: true, onClick: (event) => handleListItemClick(event, index) },
            React.createElement(material_1.ListItemIcon, null,
                React.createElement(material_1.Radio, { edge: "start", checked: props.platform.name === platform.name, tabIndex: -1, disableRipple: true })),
            React.createElement(material_1.ListItemText, { primary: platform.display })));
    });
    return (React.createElement(material_1.Container, { maxWidth: props.maxWidth, style: { marginTop: '1rem', marginBottom: '1rem' } },
        React.createElement(material_1.Paper, { style: { padding: '2rem' } },
            React.createElement(material_1.Typography, { variant: "h6" }, "Which platform are you using?"),
            React.createElement(material_1.List, null, listItems))));
}
exports.default = ChoosePlatformContainer;
